...
# PCA
## Option 1: Use only variable features
human<-RunPCA(human, features = VariableFeatures(object = human))

## Option 2: Use all genes
human<-RunPCA(human)
...
plot6<-FeaturePlot(human, features = c("PAX6", "NEUROD2", "GAD1", "PDGFRA", "AQP4", "PTPRC"))
plot7<-VlnPlot(human, features =  c("PAX6", "NEUROD2", "GAD1", "PDGFRA", "AQP4", "PTPRC"))
